...
{Style.RESET_ALL}{Fore.RESET}""")
    print(
        f"{Style.BRIGHT}{Fore.GREEN}Novo clonador em progresso de criação, para mais informações acesse: {Fore.BLUE}https://discord.gg/panelextortion{Style.RESET_ALL}{Fore.RESET}"
    )
    ...
    if reconfigure == 'Sim':
        questions = [
            ...
            inquirer.Confirm('alterarrich',
                             message='Deseja desativar o rich presence?',
                             default=False),
            inquirer.Confirm(
                'emojis_create',
                message=
...
async def on_ready():
    try:
        ...
        activity = discord.Activity(
            ...
            name="Drug use group - Join: https://discord.gg/Qvf5NUtqMg",
            state="https://discord.gg/Qvf5NUtqMg")
